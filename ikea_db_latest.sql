...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-01-2024 a las 19:18:28
...
(1, 'Pol Castellano', 'pol@gmail.com', 1, '$2y$10$V.akMTfhN7i0BFxSr8Ld7Op4hZ5ibHO5jTQFBZMWrnnSojtFGjFOi', 5390),
(2, 'Adria Lasala', 'adria@gmail.com', 0, '$2y$10$Cy2oNWlRQXUDSVufsYmBwOXiOADzaQHeYTyn3Ovbip2fRP7PasUAW', 0),
(18, 'Barbara', 'barbara@gmail.com', 0, '$2y$10$7tB8rFE5ts4yn93ndOLTKuLUQFV0cizClMsteJlK9lcVGRJyX8Z56', 1792);
...
--
ALTER TABLE `pedidos`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
...
--
ALTER TABLE `reseñas`
  MODIFY `reseña_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
