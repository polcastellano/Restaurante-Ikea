...
//         <article class="card rounded-0 border-0 border-bottom col-7 mb-3">
//             <div class="card-body">
//                 <div>
...
//                     </svg>
//                 </div>
//                 <h5 class="card-title">${reseña.nombre_usuario}</h5>
//                 <p class="card-text">Comentario: ${reseña.comentario}</p>
//                 <p class="card-text">Valoracion: ${reseña.valoracion}</p>
//             </div>
//         </article>
//          `;