document.addEventListener('DOMContentLoaded', function(){
    ...
    let orders = document.querySelectorAll('.iconosOrden');
...
//Array para guardar las reseñas y luego ordenar y filtrar estas mismas
let arrayReseñas;
...
function asignarEstrella(numero){
    ...
    while (sectionReseñas.firstChild) {
        sectionReseñas.removeChild(sectionReseñas.firstChild);
    }
...
function asignarOrden(cadena){
    ...
    if (cadena == 'asc'){
        let arrayOrdenado = arrayReseñas.sort((a, d) => d.valoracion - a.valoracion);
        montarReseñas(arrayOrdenado);
    }else if (cadena == 'desc'){
        let arrayOrdenado = arrayReseñas.sort((a, d) => a.valoracion - d.valoracion);
        montarReseñas(arrayOrdenado);
    }
    
};

function montarReseñas(reseñas){
    let sectionReseñas = document.getElementById('resenas');
