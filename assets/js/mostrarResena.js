document.addEventListener('DOMContentLoaded', function(){
    ...
    let pedido_id = document.getElementById('pedido_id2').value;
    let usuario_id = document.getElementById('usuario_id2').value;
...
function mostrarReseña(reseña){
    let sectionReseñas = document.getElementById('reseñaPed');
    sectionReseñas.classList.add("col", "mt-3");
    ...
    titulo.textContent = reseña[0].nombre_usuario;

    pComentario.classList.add("card-text");
    pComentario.textContent = `Comentario: ${reseña[0].comentario}`;

    let estrellasValoracion = generarValoracion(reseña[0].valoracion);
